<template>
    <div class="fixed z-modal w-full flex flex-col items-center pt-2 h-screen md:w-10 bg-purple-900 text-white cursor-pointer">
        ...
        <i-icon icon="bi:github" class="icon-button" @click="$dialogBus('linkToGithub'),$eventBus('desktopSidebarLeft')" title="Github"/>
