<template>
    <div id="contentEditor" ref="contentEditor" class="z-highest border bg-white shadow flex flex-col items-start justify-around flex-col w-1/3" :style="stile" v-if="$store.state.editor.current">
