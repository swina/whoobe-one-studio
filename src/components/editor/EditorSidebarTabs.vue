<template>
    <div v-if="$store.state.editor.current" class="pl-1 cursor-pointer text-gray-400">
        ...
        <i-icon icon="tabler:template" class="icon-button ml-0 mb-1" :class="iconTab==='snippets'?'bg-purple-600 text-white':null" @click="sidebar('snippets')"  title="One click template"/>
